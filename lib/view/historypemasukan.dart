...
import 'package:atm/view/detailpemasukan.dart';
...
class _HistoryPemasukanState extends State<HistoryPemasukan> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("History Deposito",
                ...
                new Padding(
                  ...
                  child: new TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Pencarian berdasarkan tujuan bank ...',
                      contentPadding:
          ...
          return filter == null || filter == ""
              ? GestureDetector(
                  onTap: () => Navigator.of(context).push(new MaterialPageRoute(
                      builder: (BuildContext context) => new DetailPemasukan(
                            list: users,
                            index: index,
                          ))),
                  child: Card(
                    child: DefaultTextStyle(
                      ...
                      child: new ListTile(
                        title: new Text(users[index]['jenis_dana'] ?? ''),
  ...
  void _getMoreData(int index, String id) async {
    if (!isLoading) {
      ...
      var url = BaseUrl.getHistoryPemasukan +
          "user_id=" +
          idUsers +
          "&limit=10&page=" +
          index.toString();
